    ...
    <div className="container mx-auto py-8 px-4 max-w-3xl">
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-6 text-foreground/90 leading-relaxed">
          ...
          <p>By accessing or using the YachtMob platform ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to all of these Terms, do not use the Service. These Terms apply to all visitors, users, and others who access or use the Service.</p>

          <h2 className="text-2xl font-semibold text-foreground pt-4">2. Description of Service</h2>
          <p>YachtMob provides an online platform for users to list, discover, and connect regarding boats and yachts. We are not a party to any transaction between buyers and sellers.</p>
          ...
          <p>By posting Content on or through the Service, you grant YachtMob a worldwide, non-exclusive, royalty-free license (with the right to sublicense) to use, copy, reproduce, process, adapt, modify, publish, transmit, display, and distribute such Content in any and all media or distribution methods.</p>
          
          <h2 className="text-2xl font-semibold text-foreground pt-4">6. Intellectual Property</h2>
          <p>The Service and its original content (excluding Content provided by users), features, and functionality are and will remain the exclusive property of YachtMob and its licensors. The Service is protected by copyright, trademark, and other laws of both the [Your Country/Jurisdiction] and foreign countries.</p>
          ...
          <p>If you have any questions about these Terms, please contact us at support@yachtmob.example.com.</p>
        </CardContent>
      </Card>
    </div>
  );
