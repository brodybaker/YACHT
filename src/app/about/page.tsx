      ...
      <Card className="shadow-lg">
        <CardHeader>
          <div className="flex items-center mb-4">
            ...
            <CardTitle className="font-headline text-4xl text-primary">About NauticalMatch</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-6 text-foreground/90 leading-relaxed">
          <p>
            Welcome to NauticalMatch, your premier destination for discovering, buying, and selling boats and yachts.
          ...
          <p>
            ...
            NauticalMatch is here to help you navigate the waters.
          </p>
          ...
          <p>
            Thank you for choosing NauticalMatch. We're excited to help you find your perfect match on the water!
          </p>
        </CardContent>
      </Card>
    </div>
